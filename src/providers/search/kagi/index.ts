...
import { validate_api_key, retry_with_backoff } from '../../../common/utils.js';

export class KagiSearchProvider implements SearchProvider {
  name = 'kagi';
  description = 'High-quality search results with minimal advertising influence, focused on authoritative sources. Features strong privacy protection and access to specialized knowledge indexes. Best for research, technical documentation, and finding high-quality content without SEO manipulation.';
...
export class KagiFastGPTProvider {
  name = 'kagi_fastgpt';
  description = 'Quick AI-generated answers with citations, optimized for rapid response (900ms typical start time). Runs full search underneath for enriched answers. Best for questions needing immediate, factual responses with source verification.';
